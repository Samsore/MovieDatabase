...
INSERT INTO Movie (Name, Length, released, description) values ('Se7en', 127, '09/22/1995', 'Two detectives, a rookie and a veteran, hunt a serial killer who uses the seven deadly sins as his modus operandi. ');
...
INSERT INTO Movie (Name, Length, released, description) values ('Goodfellas', 146, '09/21/1990', 'Henry Hill and his friends work their way up through the mob hierarchy.');
...
INSERT INTO Movie (Name, Length, released, description) values ('The Godfather', 175, '03/24/1972', 'The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.');
...
INSERT INTO Movie (Name, Length, released, description) values ('Forrest Gump', 144, '07/06/1994', 'Forrest Gump, while not intelligent, has accidentally been present at many historic moments, but his true love, Jenny Curran, eludes him.');
INSERT INTO Movie (Name, Length, released, description) values ('Name', 999, '5/55/5555', '  ');
INSERT INTO Movie (Name, Length, released, description) values ('Name', 999, '5/55/5555', '  ');
INSERT INTO Movie (Name, Length, released, description) values ('Name', 999, '5/55/5555', '  ');
INSERT INTO Movie (Name, Length, released, description) values ('Name', 999, '5/55/5555', '  ');
INSERT INTO Movie (Name, Length, released, description) values ('Name', 999, '5/55/5555', '  ');
